class Metadata:
    ...
    def __init__(self):
        ...
        self.description = 'A program to detect personal activity patterns of individual participants wearing a GPS data logger and a physical activity monitor'
...
class Input:
    ...
    def update(self, interval, insert_missing, insert_until,
        ...
        self.data['accelerometer']['parameters']['sedentary_bout'][
            'sedentary_bout_tolerance'] = sedentary_bout_tolerance
